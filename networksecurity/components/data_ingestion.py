...
#confriguation of data ingestion config

from networksecurity.entity.config_entity import DataIngistionConfig
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, df:pd.DataFrame):
        try:
            ...
            logging.info("exporting train test split file path.")
            ...
            logging.info("Exported train test in training file path")
