...
from networksecurity.entity.config_entity import DataIngistionConfig,DataValidationConfig,DataTransformationconfig,ModelTrainerConfig
...
if __name__=='__main__':
    try:
        ...
        data_ingestion_config = DataIngistionConfig(training_pipeline_config)
        ...
        logging.info("data transformaation completed")
        print(data_transformation_artifact)
        
        logging.info("initiate model training")
        model_training_config = ModelTrainerConfig(training_pipeline_config=training_pipeline_config)
        model_trainer = ModelTrainer(model_trainer_config=model_training_config,
